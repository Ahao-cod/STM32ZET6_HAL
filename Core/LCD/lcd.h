...
#define GPIOx_LCDLED_PORT GPIOB
#define LCD_LED_PIN GPIO_PIN_0
#define LCD_LED_ON() /*亮*/ HAL_GPIO_WritePin(GPIOx_LCDLED_PORT, LCD_LED_PIN, GPIO_PIN_SET)
#define LCD_LED_OFF() /*灭*/ HAL_GPIO_WritePin(GPIOx_LCDLED_PORT, LCD_LED_PIN, GPIO_PIN_RESET)
...
void delay_us(__IO uint32_t delay); // 微妙延时
